...
class TestBase(unittest.TestCase):
    """Testing for models/rectangle.py"""

    """attributes"""
    def test_all_attr_given(self):
        """if attributes match what's given"""
    ...
    def test_default_attr(self):
        """default attributes are set when not given"""
        r2 = Rectangle(3, 4)
    ...
    """class"""
    def test_class(self):
        """clas created is indeed Rectangle"""
    ...
    def test_update(self):
        ...
        """mixture of valid and invalid *kwargs"""
